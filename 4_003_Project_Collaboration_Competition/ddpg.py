...
class Agent(object):
    ...
    def memorize(self, state, action, reward, next_tate, done):
        ...
        for agent in range(self.num_agents):
            self.memory.add(state[agent, :], action[agent, :], reward[agent], next_tate[agent, :], done[agent])
    ...
    def act(self, states, add_noise=True):
        ...
        if add_noise:
            actions += (self.noise.sample() * self.exploration)
    ...
    def learn(self):
        ...
        else:  # Not enough memory buffer size
            pass
